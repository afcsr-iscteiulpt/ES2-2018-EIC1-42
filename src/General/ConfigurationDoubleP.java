...
public class ConfigurationDoubleP extends Configuration {
	...
	/**
	 * 
	 * Construtor da classe ConfigurationDoubleP
	 * 
	 * @param path
	 * @param ToRun
	 */
	...
	// automatic configuration of algorithms for the problem..(Only NSGAII for now)
	// review "Double"Solution and AlgorithmBuilder chosen
